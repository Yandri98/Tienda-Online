...
<div class="container-fluid">
  <div class="row">
  		<div class="col-md-3">
			  ...
			  <div class="header">
				  <h2 class="title"><i class="fas fa-plus"></i> Agregar Categorías</h2>
			   </div>
  ...
  <!--Modulo ver productos-->
  <div class="col-md-9">
  	 <div class="panel shadow">
			  <div class="header">
				  <h2 class="title"><i class="fa-solid fa-folder-tree"></i>Categorías</h2>
			  </div>	
			  <div class="inside">
			  	<div class="nav nav-pills nav-fill">
			  		@foreach(getModulesArray() as $m => $k)
			  		<a class="nav-link" href="{{url('/admin/categories/'.$m)}}"><i class="fa-solid fa-list-check"></i>{{ $k }}</a>
			  		@endforeach
			  	</div>
			  	<table class="table mtop16">
			  		<thead>
			  			<tr>
			  				<td width="32">Icono</td>
			  				<td>Nombre</td>
			  				<td width="140"></td>
			  			</tr>
			  		</thead>
